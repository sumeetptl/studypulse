...
from .views import TopicListCreateAPIView, TopicRetrieveUpdateDestroyAPIView, RoomListCreateAPIView, RoomRetrieveUpdateDestroyAPIView, MessageListCreateAPIView
...
urlpatterns = [
    ...
    # path('messaged/<int:pk>/', MessageRetrieveUpdateDestroyAPIView.as_view(), name='message-retrieve-update-destroy'),
]
